...
<section>
    ...
    <div class="container theme-showcase" id="cal">
        <h1>Les différents événements enregistrés jusqu'à présent : </h1>
        <br><br>
...
<!--  <div class="contentcalendar">
    ...
    <div class="dialog" id="dialog">
        <h2 class="dialog-header"> Ajouter Ã©vÃ©nement</h2>
        <form class="form" id="form">
          <div class="form-container" align="center">
            <label class="form-label" id="valueFromMyButton" for="name">Nom de l'Ã©vÃ©nement</label>
            <input class="input" type="text" id="name" maxlength="36">
            <label class="form-label" id="valueFromMyButton" for="count">Nombre de membres invitÃ©s</label>
